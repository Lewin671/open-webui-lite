...
const SuggestionCard = ({ title, description }) => {
  return (
    <div className="bg-[#2a2a2a] p-3 px-4 rounded-lg cursor-pointer transition-colors duration-200 border border-[#383838] flex items-start hover:bg-[#333333]">
      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 mr-2.5 text-[#a0a0a0] flex-shrink-0 mt-0.5">
      ...
      <div className="flex flex-col">
          <h5 className="text-sm font-medium mb-0.5 text-[#e0e0e0] leading-snug">{title}</h5>
...
const ChatView = () => {
  return (
    <section className="overflow-y-auto flex flex-col items-center justify-center w-full">
      <div className="text-center flex flex-row items-center justify-center gap-5">
         ...
         <div className="text-4xl text-[#e0e0e0] m-0">deepseek-chat</div>
      </div>

      <div className="w-full max-w-[768px] mx-auto flex flex-col items-center">
         {/* Removing the suggestion cards from the main view */}
         {/* <h4 className="text-sm font-medium text-[#a0a0a0] mb-4 flex items-center">建议</h4> */}
