...
const SuggestionItem = ({ title, description }) => {
  return (
    <div className="bg-transparent py-1.5 cursor-pointer rounded-md transition-colors duration-200 hover:bg-[#2a2a2a]">
      <h5 className="text-sm font-medium mb-0.5 text-[#e0e0e0]">{title}</h5>
      <p className="text-xs text-[#a0a0a0] leading-relaxed m-0">{description}</p>
    </div>
  );
};
    ...
    <div className="flex flex-col w-full items-center">
      <div className="flex flex-col w-full max-w-[768px] items-center">
        ...
        <div className="block w-full py-3">
          <div className="flex items-center bg-[#2a2a2a] border border-[#383838] rounded-full w-full min-h-[52px] shadow-sm">
            <button className="text-[#a0a0a0] flex items-center justify-center p-2 rounded-full hover:bg-[#383838] hover:text-[#e0e0e0] mr-1.5">
              {/* '+' Icon SVG */}
            ...
            <input
              ...
              className="flex-grow bg-transparent border-none outline-none text-[#e0e0e0] text-[15px] py-2.5 px-3 mx-2 min-h-6"
            />

            <button className="text-[#a0a0a0] flex items-center justify-center p-2 rounded-full hover:bg-[#383838] hover:text-[#e0e0e0] ml-1.5">
      ...
      <div className="mx-5 max-w-[42rem] w-full">
        <div className="flex items-center gap-1.5 text-sm font-medium text-[#a0a0a0] mb-3">
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 opacity-70">
